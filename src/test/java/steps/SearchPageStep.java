...
/**
 * Step definition class for Search Page related Cucumber scenarios.
 * Extends TestBase to use the initialized WebDriver and other utilities.
 * Maps Gherkin steps to methods that interact with the SearchPage POM class.
 */
public class SearchPageStep extends TestBase{
	...
	/**
	 * Step: Searches for a product by entering the product name into the search bar.
	 *
	...
	/**
	 * Step: Verifies that the search results display items related to the searched product.
	 *
	 * @param productName The expected product name to verify in search results.
	 */
	...
	/**
	 * Step: Adds the first product in the search results to the wishlist.
	 */
	...
	/**
	 * Step: Verifies that the product was added to the wishlist successfully.
	 */
	...
	/**
	 * Step: Clicks on the "View Product" button for the first product in search results.
	 */
	...
	/**
	 * Step: Verifies that the product details page opens and displays correct product information.
	 */
	...
	/**
	 * Step: Applies a price filter on the search results page.
	 */
	...
	/**
	 * Step: Ensures that all displayed products fall within the applied price range.
	 */
	...
	/**
	 * Step: Verifies the product details listed in the Wishlist page
	 * match the product added from search results.
	 */
	...
	/**
	 * Step: Adds the first product in search results to the Compare section.
	 */
	...
	/**
	 * Step: Verifies that the product is successfully added to the Compare section.
	 */
